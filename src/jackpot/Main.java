...
public class Main extends javax.swing.JFrame {
        ...
        //Creamos las constantes correspondientes que usaremos más adelante
        double CINCUENTACENTIMOS = 0.50;
        double UNEURO = 1;
        double DOSEUROS = 2;
        ...
        /*Creamos el formato de moneda que deseamos para las cantidades que 
         * apareceran en pantalla*/
        Locale spain = new Locale("es","ES");
        NumberFormat formatoMoneda = NumberFormat.getCurrencyInstance(spain);
        
        //Creamos el Array que utilizaremos en el programa
        int[] ArrayCombinaciones = new int[3];
        
        /*Generamos un número aleatorio entre 1 y 4 que serán las imágenes 
         *que utilizaremos de combinaciones*/
        int combinaciones;
    ...
    public Main() {
        ...
        System.out.println(formatoMoneda.format(deposito));
        
        //Al iniciar el programa no se podrá jugar al no tener dinero invertido
   ...
   /**
    ...
    private void jButtonPalancaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonPalancaActionPerformed
        ...
        if(saldo != 0){
            ...
            for(int i=0; i<ArrayCombinaciones.length; i++){
                ArrayCombinaciones[i] = Generador.nextInt(4);
            }
            
            jLabelImagen1.setIcon(new ImageIcon(getClass().getResource("/imagenes/" + ArrayCombinaciones[0] + ".png")));
            jLabelImagen2.setIcon(new ImageIcon(getClass().getResource("/imagenes/" + ArrayCombinaciones[1] + ".png")));
            jLabelImagen3.setIcon(new ImageIcon(getClass().getResource("/imagenes/" + ArrayCombinaciones[2] + ".png")));
            
            if(ArrayCombinaciones[0] == 0){
                premio = 1;
                saldo += 1;
                deposito -= 1;
                jLabelPremio.setText(formatoMoneda.format(premio));
            ...
            if(ArrayCombinaciones[0] == 0 && ArrayCombinaciones[1] == 0){
                premio = 5;
                saldo += 5;
                deposito -= 5;
                jLabelPremio.setText(formatoMoneda.format(premio));
            ...
            if(ArrayCombinaciones[0] == 1 && ArrayCombinaciones[1] == 1 && ArrayCombinaciones[2] == 4){
                premio = 10;
                saldo += 10;
                deposito -= 10;
                jLabelPremio.setText(formatoMoneda.format(premio));
            ...
            if(ArrayCombinaciones[0] == 1 && ArrayCombinaciones[1] == 1 && ArrayCombinaciones[2] == 1){
                premio = 10;
                saldo += 10;
                deposito -= 10;
                jLabelPremio.setText(formatoMoneda.format(premio));
            ...
            if(ArrayCombinaciones[0] == 2 && ArrayCombinaciones[1] == 2 && ArrayCombinaciones[2] == 2){
                premio = 15;
                saldo += 15;
                deposito -= 15;
                jLabelPremio.setText(formatoMoneda.format(premio));
            ...
            if(ArrayCombinaciones[0] == 2 && ArrayCombinaciones[1] == 2 && ArrayCombinaciones[2] == 4){
                premio = 15;
                saldo += 15;
                deposito -= 15;
                jLabelPremio.setText(formatoMoneda.format(premio));
            ...
            if(ArrayCombinaciones[0] == 3 && ArrayCombinaciones[1] == 3 && ArrayCombinaciones[2] == 3){
                premio = 20;
                saldo += 20;
                deposito -= 20;
                jLabelPremio.setText(formatoMoneda.format(premio));
            ...
            if(ArrayCombinaciones[0] == 3 && ArrayCombinaciones[1] == 3 && ArrayCombinaciones[2] == 4){
                premio = 20;
                saldo += 20;
                deposito -= 20;
                jLabelPremio.setText(formatoMoneda.format(premio));
            ...
            if(ArrayCombinaciones[0] == 4 && ArrayCombinaciones[1] == 4 && ArrayCombinaciones[2] == 4){
                premio = 100;
                saldo += 100;
                deposito -= 100;
                jLabelPremio.setText(formatoMoneda.format(premio));
    ...
    private void jButton50centActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton50centActionPerformed
        ...
        saldo += CINCUENTACENTIMOS;
        jLabelSaldo.setText(formatoMoneda.format(saldo));
        
        deposito += CINCUENTACENTIMOS;
        System.out.println(formatoMoneda.format(deposito));
